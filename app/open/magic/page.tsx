...
export default function OpenMagicPage() {
  useEffect(() => {
    // Try to open the app with the greenhaus://open/magic scheme
    const appUrl = "greenhaus://open/magic";
